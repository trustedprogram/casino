...
function my_custom_menu() {
    register_nav_menu('my-custom-menu',__( 'Casino Menu' ));
}
add_action( 'init', 'my_custom_menu' );


function casion_register_styles() {
	wp_enqueue_script( 'casino-bootstrap', get_template_directory().'/page-homepage.css',array(),'1.0','All' );
}

add_action( 'after_setup_theme', 'casion_register_styles');
